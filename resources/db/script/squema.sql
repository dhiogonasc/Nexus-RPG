...
CREATE TABLE mission (
	...
	CONSTRAINT ck_mission_difficulty CHECK (difficulty IN ('EASY', 'MEDIUM', 'HARD'))
);
...
CREATE TABLE question (
	...
	CONSTRAINT ck_question_tag CHECK(tag IN ('QUESTION'))
);
...
CREATE TABLE achievement (
    ...
    CONSTRAINT ck_achievement_type CHECK (
        "type" IN ('UNLOCK', 'COMPLETE', 'PERFECT', 'COLLECTION')
    ),
    CONSTRAINT ck_achievement_target_type CHECK (
        target_type IN ('LEVEL', 'MISSION', 'PLANET', 'GAME')
    )
);
