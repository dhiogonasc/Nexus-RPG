...
ADD CONSTRAINT fk_user_stat_current_planet 
FOREIGN KEY(current_planet_id) REFERENCES "planet"(id) 
ON DELETE CASCADE;
...
ALTER TABLE "user_stat" 
ADD CONSTRAINT fk_user_stat_current_mission 
FOREIGN KEY(current_mission_id) REFERENCES "mission"(id) 
ON DELETE CASCADE;
