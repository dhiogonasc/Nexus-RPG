...
public interface UserMissionRepository extends JpaRepository<UserMission, Long>, UEntityRepository<UserMission> {
    ...
    Optional<UserMission> findByUserIdAndEntityId(@Param("userId") Long userId, @Param("baseId") Long baseId);
