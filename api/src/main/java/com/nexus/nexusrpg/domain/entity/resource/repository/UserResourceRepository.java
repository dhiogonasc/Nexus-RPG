...
public interface UserResourceRepository extends JpaRepository<UserResource, Long>, UEntityRepository<UserResource> {
    ...
    Optional<UserResource> findByUserIdAndEntityId(@Param("userId") Long userId, @Param("baseId") Long baseId);
